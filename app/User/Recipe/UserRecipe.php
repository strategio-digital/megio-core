...
class UserRecipe extends CollectionRecipe
{
    ...
    public function search(
        ...
        return $builder
            ->keepDefaults()
            ->addSearchable(
                new Searchable(column: 'email', operator: 'LIKE', formatter: fn(
                    $value,
                ) => "%{$value}%"),
            )
    ...
    public function read(
        ...
        return $builder
            ...
            ->add(
                new EmailColumn(key: 'email', name: 'E-mail', formatters: [
    ...
    public function create(
        ...
        return $builder
            ->add(
                new EmailField(name: 'email', label: 'E-mail', rules: [
                    new RequiredRule(),
                    new UniqueRule(
            ...
            ->add(
                new PasswordField(name: 'password', label: 'Heslo', rules: [
                    new RequiredRule(),
                    new MinRule(6),
                    new MaxRule(32),
                ]),
            ...
            ->add(
                new PasswordField(name: 'password_check', label: 'Heslo znovu', rules: [
                    new RequiredRule(),
